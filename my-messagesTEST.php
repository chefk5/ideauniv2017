...
if (isset($_GET['mid'])) {
        ...
        ?>
        <form action="send-messageTEST.php?receiver=<?php echo $id; ?>" method="post">
...
foreach ($messages as $message) {
        ...
        if ($message['read'] == 0) {
                echo "<a href='my-messagesTEST.php?mid=".$message['id']."'><strong>".$m."</strong></a> sent by ".$message['username'].'<hr />';
        } else {
                echo "<a href='my-messagesTEST.php?mid=".$message['id']."'>".$m."</a> sent by ".$message['username'].'<hr />';
        }
}
}
?>